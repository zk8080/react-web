...
<table class="print_paper">
    <tr height="56">
        <td class="tc f30 b fam"> 福田区
        </td>
    </tr>
</table>
<table class="print_paper">
    <tr height="34">
        <td width="275" class="pl5 f16"> 广东省深圳市
        </td>
        <td class="tc">
...
<table class="print_paper">
    <tr height="71">
        <td width="20"> 收件</td>
        <td class="f11 vt">
            <div style="height: 70px;overflow:hidden;"> 张三 13709076789
                <br/> 广东省深圳市福田区深南大道2009号
            </div>
        </td>
    ...
    <tr height="48">
        <td width="20"> 寄件</td>		<td class="f8 vt">
            <div style="height: 47px;overflow:hidden;"> 李四 13932080778
                <br/> 广东省深圳市福田区福田保税区
            </div>
        </td>
    </tr>
...
<table class="print_paper">
    <tr height="48">
        <td width="20"> 收件</td>
        <td class="f8 vt">			<div style="height: 47px;overflow:hidden;"> 张三 13709076789
                <br/> 广东省深圳市福田区深南大道2009号
            </div>
        </td>
    ...
    <tr height="37">
        <td width="20"> 寄件</td>
        <td class="f8 vt" >
        <div style=" height:36px;overflow:hidden; "> 李四 13932080778 <br/> 广东省深圳市福田区福田保税区
        </div>
    </td>
</tr>
</table>
