	...
	render() {
		return <Row>
			<Row  className={'header-component'}>
				<Col span={6} >
					<Input.Search placeholder="请锁定快递单号"  enterButton={
						<Icon type="unlock" title="解锁"/>
					} onSearch={this.orderWeighState.lockOrder.bind(this.orderWeighState)}/>
				</Col>
				<Col span={6}>
					<Input.Search type="number" placeholder="包裹称重重量" onSearch={this.orderWeighState.weigh.bind(this.orderWeighState)}  enterButton="比对"/>
				</Col>
